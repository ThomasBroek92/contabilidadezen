  ...
  return (
    <>
      <SEOHead
        ...
        description="Entre em contato com a Contabilidade Zen. Agende uma consulta gratuita com nossos especialistas em contabilidade para profissionais da saúde. WhatsApp: (19) 97415-8342."
        keywords="contato contabilidade zen, agendar consulta, contabilidade saúde contato, whatsapp contador"
        canonical="/contato"
        pageType="contact"
        includeOrganization
