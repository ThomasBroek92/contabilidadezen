    ...
    <section className="py-16 lg:py-24 bg-[#FAF5FF]">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          {gmbStats && (
            <a href="https://g.page/r/CSe4RMezF61hEAI/review" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 mt-6 px-5 py-3 bg-card border border-border rounded-xl hover:border-[#9333EA]/50 hover:shadow-card transition-all duration-300 group hover:-translate-y-0.5">
