...
const benefits = [
  ...
  },
  {
    ...
    description: "Fique tranquilo com todas as obrigações fiscais e CRP sempre em dia e corretas.",
  },
  {
    icon: Clock,
  ...
  },
  {
    ...
    description: "Equipe que entende psicologia e está sempre disponível para tirar suas dúvidas.",
  },
  {
    icon: FileCheck,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-muted-foreground text-lg">
            Especialização em psicologia para resultados que fazem a diferença no seu consultório
          </p>
        </div>
