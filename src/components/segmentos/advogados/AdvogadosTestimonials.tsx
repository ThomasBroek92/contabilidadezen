    ...
    <section className="py-16 lg:py-24 bg-[#F8FAFC]">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-10">
          {hasGMBReviews ? (
            <a href="https://g.page/r/CSe4RMezF61hEAI/review" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#334155] hover:text-[#1E293B] font-medium transition-colors">Ver todas as avaliações no Google<ExternalLink className="h-4 w-4" /></a>
