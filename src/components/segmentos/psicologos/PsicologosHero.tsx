...
import { Brain, TrendingDown, Shield, Clock } from "lucide-react";
          ...
          <div className="text-primary-foreground space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/20 border border-secondary/30">
              ...
              <span className="text-sm font-medium text-secondary">
                Contabilidade para Psicólogos e Clínicas de Psicologia
              </span>
            </div>
            
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
              Reduza impostos e aumente seus lucros com uma{" "}
              <span className="text-secondary">contabilidade especializada para psicólogos!</span>
            </h1>
            
            <p className="text-lg lg:text-xl text-primary-foreground/80 leading-relaxed">
              Está pagando mais impostos do que deveria? Especialistas em contabilidade para psicólogos 
              podem ajudar a reduzir seus custos tributários agora!
            </p>
