...
const testimonials = [
  {
    ...
    content: "Desde que contratei a Contabilidade Zen, consegui reduzir mais de 35% dos meus impostos. Finalmente tenho tranquilidade para focar nos meus pacientes.",
    rating: 5,
  },
  {
    ...
    content: "A equipe é extremamente atenciosa e entende perfeitamente as necessidades da área odontológica. Recomendo para todos os colegas de profissão!",
    rating: 5,
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-muted-foreground text-lg">
            Confira os resultados que nossos clientes dentistas estão tendo com nosso apoio
          </p>
        </div>
