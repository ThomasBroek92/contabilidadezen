  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Contabilidade digital nichada para médicos, advogados, TI, produtores digitais, e-commerce e mais. Reduza seus impostos legalmente em até 50%. 100% online, abertura de empresa grátis." 
        />
        <meta 
          name="keywords" 
          content="contabilidade para médicos, contabilidade para advogados, contabilidade para TI, contabilidade para produtores digitais, contabilidade para e-commerce, contabilidade online, abertura de empresa, planejamento tributário" 
        />
