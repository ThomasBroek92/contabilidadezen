      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg lg:text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
            Junte-se a centenas de psicólogos que já otimizaram suas finanças com a Contabilidade Zen. 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <a
                href="https://wa.me/5511999999999?text=Olá! Sou psicólogo(a) e gostaria de saber mais sobre contabilidade especializada."
                target="_blank"
